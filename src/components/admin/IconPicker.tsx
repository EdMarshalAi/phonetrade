    ...
    <div className="relative inline-block">
      ...
      {open ? (
        <>
          ...
          <div className="absolute left-0 top-[calc(100%+6px)] z-[61] w-[372px] max-w-[calc(100vw-2rem)] rounded-xl border border-border/70 bg-white p-2.5 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.25)]">
            {/* все иконки сразу, без скролл-фрейма */}
            ...
            <button
              ...
              className="mt-2 flex w-full items-center gap-2 rounded-lg border-t border-border/60 px-1.5 pt-2 text-left text-[12.5px] text-ink-muted hover:text-ink"
            >
