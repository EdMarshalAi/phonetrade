...
import { DEFAULT_ORDER_STATUSES, type OrderStatusDef, type OrderStatusTone } from "@/lib/orders/statuses";

const TONES: OrderStatusTone[] = ["neutral", "outline", "strong", "danger"];
