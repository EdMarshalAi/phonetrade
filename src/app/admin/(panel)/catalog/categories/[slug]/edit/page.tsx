...
export default async function EditCategoryPage({
  ...
  const [{ data: cat }, { data: all }] = await Promise.all([
    db
      .from("categories")
      .select("slug,title,parent_slug,subtitle,description,image,icon_url,meta_title,meta_description,seo_text,sort,show_on_home,home_limit,is_published")
      .eq("slug", slug)
      .maybeSingle(),
